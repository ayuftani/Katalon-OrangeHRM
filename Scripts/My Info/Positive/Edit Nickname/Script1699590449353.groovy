...
WebUI.verifyElementVisible(findTestObject('My Info/textbox_nickname'))

'click komponen textbox'
WebUI.click(findTestObject('My Info/textbox_nickname'))
...
'set text \'Paul\' untuk mengganti nickname'
WebUI.setText(findTestObject('My Info/textbox_nickname'), 'Paul')
...
'dilakukan untuk mengembalikan nickname menjadi semula (field kosong)'
WebUI.takeScreenshot()
