...
'verifikasi textbox nama emergency contact sudah ada'
WebUI.verifyElementVisible(findTestObject('My Info/textbox_nameEmergencyContact'))

'click textbox nama emergency contact'
WebUI.click(findTestObject('My Info/textbox_nameEmergencyContact'), FailureHandling.STOP_ON_FAILURE)

'set text menjadi Mary'
...
'verifikasi bahwa sudah data sudah tersave'
WebUI.verifyElementVisible(findTestObject('My Info/label_recordEC'))

'screenshot data yang ada'
WebUI.takeScreenshot()

'click button delete record yang baru saja diinput'
WebUI.click(findTestObject('My Info/button_deleteECRecord'))

'verifikasi popup konfirmasi delete'
WebUI.verifyElementVisible(findTestObject('My Info/button_confirmDeleteEC'))

'click button konfirmasi delete'
WebUI.click(findTestObject('My Info/button_confirmDeleteEC'))

'screenshot setelah data terhapus'
WebUI.takeScreenshot()
