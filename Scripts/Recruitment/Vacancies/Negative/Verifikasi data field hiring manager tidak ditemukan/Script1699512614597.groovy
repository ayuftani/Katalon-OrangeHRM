...
WebUI.setText(findTestObject('Recruitment/Vacancies/textbox_hiringManager'), 'Burhan')
...
WebUI.verifyElementPresent(findTestObject('Recruitment/Vacancies/label_invalidManager'), 0)
