...
WebUI.verifyElementClickable(findTestObject('Recruitment/Vacancies/button_cancel'))

WebUI.click(findTestObject('Recruitment/Vacancies/button_cancel'))

WebUI.verifyElementPresent(findTestObject('Recruitment/Vacancies/label_verifCancel'), 0)
