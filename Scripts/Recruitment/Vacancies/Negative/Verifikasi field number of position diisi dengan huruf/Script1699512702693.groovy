...
WebUI.setText(findTestObject('Recruitment/Vacancies/textbox_nop'), 'A123')
...
WebUI.verifyElementPresent(findTestObject('Recruitment/Vacancies/label_requiredNumber'), 0)
