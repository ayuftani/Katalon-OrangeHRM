...
WebUI.setText(findTestObject('Recruitment/Vacancies/textbox_vacancyName'), '')
...
WebUI.verifyElementPresent(findTestObject('Recruitment/Vacancies/label_requiredVacancy'), 0)
