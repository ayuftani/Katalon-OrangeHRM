...
WebUI.setText(findTestObject('Recruitment/Vacancies/textbox_nop'), '21')
...
WebUI.verifyElementPresent(findTestObject('Recruitment/Vacancies/label_requiredManager'), 0)
