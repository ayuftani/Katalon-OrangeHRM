...
'Masukkan password'
WebUI.setText(findTestObject('Login/textbox_Password'), 'admin1234')
...
WebUI.verifyElementVisible(findTestObject('Login/label_LoginGagal'), FailureHandling.STOP_ON_FAILURE)
