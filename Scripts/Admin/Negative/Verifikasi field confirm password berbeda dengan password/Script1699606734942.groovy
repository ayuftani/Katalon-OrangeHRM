...
WebUI.setText(findTestObject('Admin/Add User/textbox_confirmPassword'), 'testing2024!')
...
WebUI.verifyElementPresent(findTestObject('Admin/Add User/label_confirmPasswordsdonotmatch'), 0)
