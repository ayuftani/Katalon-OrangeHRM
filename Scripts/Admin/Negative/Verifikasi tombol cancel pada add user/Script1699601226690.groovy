...
WebUI.verifyElementVisible(findTestObject('Admin/Add User/button_Cancel'))

WebUI.verifyElementClickable(findTestObject('Admin/Add User/button_Cancel'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Admin/Add User/button_Cancel'))

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('Admin/Add User/label_menuAdmin'), 0)
